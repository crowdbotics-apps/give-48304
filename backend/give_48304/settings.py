"""
Django settings for give_48304 project.
...
WSGI_APPLICATION = 'give_48304.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "give_48304 API",
    "DESCRIPTION": "API documentation for give_48304 App",
    "VERSION": "v1",
}
